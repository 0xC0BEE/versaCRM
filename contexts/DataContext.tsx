...
export const DataProvider: React.FC<DataProviderProps> = ({ children }) => {
    ...
    const addDashboardWidgetMutation = useGenericMutation((id: string) => apiClient.addDashboardWidget(id), 'dashboardWidgets');
