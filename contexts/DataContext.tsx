...
export const DataProvider: React.FC<DataProviderProps> = ({ children }) => {
    ...
    const postTeamChatMessageMutation = useGenericMutation((vars: { channelId: string; userId: string; message: string }) => apiClient.postTeamChatMessage(vars), 'teamChannelMessages');
